...
public static class Fabricator
{
    ...
    public static int AddResourceId()
    {
        ...
        {
            throw new System.Exception("–есурсы уже инициализированы, добавление новых невозможно!");
        }
    ...
    public static void ResourceInit()
    {
        ...
        if (resourcesInitialized)
        {
            throw new System.Exception("–есурсы уже инициализированы!");
        }
    ...
    public static Resource CreateResource(int newResourceId, int count)
    {
        ...
        {
            throw new System.Exception("ѕроизведена попытка создать ресурс неизвестного типа!");
        }
    ...
    public static void CreateCell(int newCellTypeId, Vector2Int coords, Map map)
    {
        ...
        {
            throw new System.Exception("ѕроизведена попытка создать €чейку неизвестного типа!");
        }
    ...
    public static Item CreateItem(int newItemId)
    {
        ...
        {
            throw new System.Exception("ѕроизведена попытка создать неизвестный предмет!");
        }
